`extract_lake_area.py` extracts lake area for every lake within the Prior Lakes Database (PLD) for the period 1999-2021 for both the GSWO ("JRC/GSW1_4/MonthlyHistory")  and GLAD (asset ID: 'projects/glad/water/C2/individualMonths') datasets. This code was developed and run in 2025.
